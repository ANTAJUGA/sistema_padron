...
?>
    <div class="alert alert-danger">
        ...
        <button onclick=" window.location.href='adherenteView.php'"  class=" close" data-dismiss="alert">
...
<?php
} else if ($_GET['estado'] === 'apagado') {
?>
    <h4 class="header blue lighter bigger center">
        <div class="alert alert-danger">
            <i class="ace-icon fa fa-exclamation-triangle bigger-120""></i>
			<strong>Error del Sistema:</strong> El sistema estara accesible en horario de 08H00 17H00 , para mayor información contacte con el administrador.        
			<button onclick=" window.location.href='index.php'"  class=" close" data-dismiss="alert">
            <i class="ace-icon fa fa-times"></i>
            </button>
        </div>
    </h4>
