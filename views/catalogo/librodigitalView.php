...
?>
	<body class="no-skin">
				...
				<div class="navbar-buttons navbar-header pull-right" role="navigation">
					...
					<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="../assets/images/avatars/job_avatar.jpg" alt="Jason's Photo" />
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<?php 
				include_once("../MenuDespegable.php");
			?>
							...
							<div class="col-xs-6 col-sm-11">
								...
								<div>
									<ul class="ace-thumbnails clearfix">
										...
										<li class="col-xs-2">
											<a href="https://drive.google.com/file/d/1tA301BBetPFeqKsqJELgOg3k1yIqYw6_/view" target="_blank" title="Photo Title">
